...
p2<-ggplot(d[good_p,],aes(x=F_BIN))+geom_bar(fill="darkorange2")+geom_text(stat='count', aes(label=..count..), position ="stack",color="black") +
 labs(title=name,x="DAF",y="Amount of SNPs ")
...
p6<-ggplot(d[good_p,], aes(x=as.factor(F_BIN), y=BETA))+geom_boxplot(fill="darkorange2") +
...
pa2<-ggplot(alch[pval,],aes(x=F_BIN))+geom_bar(fill="darkorange2")+geom_text(stat='count', aes(label=..count..), position ="stack",color="black") +
 labs(title=name_alch,x="DAF",y="Amount of SNPs ")
...
pa6<-ggplot(alch[pval,], aes(x=as.factor(F_BIN), y=beta_T))+geom_boxplot(fill="darkorange2") +
 labs(title=name_alch,x="DAF",y="beta_T ")
